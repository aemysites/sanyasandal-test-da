...
## Environments
- Preview: https://main--sanyasandal-test-da--aemysites.aem.page/
- Live: https://main--sanyasandal-test-da--aemysites.aem.live/
- Block Library: https://main--sanyasandal-test-da--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sanyasandal-test-da` directory in your favorite IDE and start coding :)
